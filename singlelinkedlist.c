...
DATE OF PERFORMANCE:30/07/2015 
DATE OF SUBMISSION:1/10/2015
*/
#include<stdio.h>
#include<malloc.h>
void disp();
...
{int c=0;
	if(START==NULL)
printf("\nNumber of elements in the list is %d",c);
else
{
struct node*p;
p=START;
...
Number of elements in the list is:2
do you want to continue?
If yes then press1 else press 01
******WELCOME TO SINGLE LINKED LIST******
enter 1 to display
...
enter the element you want to search9
...
enter the location to be deleted8
...
--------------------------------
Process exited after 85.77 seconds with return value 0
